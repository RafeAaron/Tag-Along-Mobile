...
public final class FragmentPaymentBinding implements ViewBinding {
  ...
  public static FragmentPaymentBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.amountInWallet;
      TextView amountInWallet = ViewBindings.findChildViewById(rootView, id);
      if (amountInWallet == null) {
        break missingId;
      }
      ...
      id = R.id.pendingPaymentHeading;
      TextView pendingPaymentHeading = ViewBindings.findChildViewById(rootView, id);
      if (pendingPaymentHeading == null) {
        break missingId;
      }
